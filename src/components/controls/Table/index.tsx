...
export const Container = ({ children, link, classes, ...props }: NavLinkType) => {
  ...
  return link ? (
    linkType === "reactRouter" ? (
      <NavLink {...props} className={defaultClasses + linkClass} to={link}>
        {children}
      </NavLink>
    ) : linkType === "next" ? (
      <NavLink {...props} className={defaultClasses + linkClass} href={link}>
        {children}
      </NavLink>
    ) : (
      <NavLink {...props} className={defaultClasses + linkClass} href={link}>
